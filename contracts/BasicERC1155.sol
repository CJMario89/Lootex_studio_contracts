    ...
    IBasicERC1155
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("BasicERC1155");
    ...
    function getInfo() external view returns (string memory, string memory, uint256) {
        return (name, "BasicERC1155", initialDate);
    }
    ...
    function setUri(uint256 _tokenId, string memory _uri) external onlyRole(DEFAULT_ADMIN_ROLE) {
