    ...
    IBasicERC721LimitedEdition
{
    ...
    /// @dev Only MINTER_ROLE holders can mint.
    ...
    /// @dev The maximum of token supplied(LimitedEdition).
    ...
    function _mintTo(address _to, string calldata _uri) internal returns (uint256 tokenIdToMint) {
        ...
        require(tokenIdToMint < maxSupply, 'exceed maxSupply');
        nextTokenIdToMint += 1;
    ...
    /// @dev Prevent token miss transfer into the contract
    function collectMistakeCurrency(address currency, address receiver, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
